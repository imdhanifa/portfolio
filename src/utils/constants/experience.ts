export const EXPERIENCE = {
    title: "Experience",
    slogan: "You need it to get the job, but the job's what gives it!",
    summary: "Throughout my journey as a developer, I’ve worked with cutting-edge technologies while mastering the art of debugging at 2 AM. From building dynamic web apps to solving cryptic errors, my experience has been a blend of structured learning and spontaneous problem-solving. Each role has sharpened my ability to write clean code, collaborate effectively, and—most importantly—fix bugs before they fix me.",
    records: [
        {
        ...
        {
            role: "Software Developer",
            organization: "Tripwerkz India Pvt Ltd",
